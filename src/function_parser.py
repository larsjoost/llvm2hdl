...
from llvm_parser import ConstantContainer, LlvmFunction, CallInstructionParser
...
class FunctionParser:
    ...
    def parse(self, function: LlvmFunction, constants: ConstantContainer, file_handle: FunctionGenerator, statistics) -> FunctionContents:								
